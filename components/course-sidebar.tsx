...
export function CourseSidebar({
  ...
  return (
    <>
      <div className="fixed left-0 top-0 h-screen w-64 border-r-2 border-primary/20 bg-card/90 backdrop-blur-sm overflow-y-auto flex flex-col shadow-lg">
        <div className="flex items-center justify-between border-b-2 border-primary/20 p-1">
          <div className="flex items-center gap-2">
            <BookOpen className="h-5 w-5 text-primary" />
            <span className="text-sm font-semibold text-foreground">Course Overview</span>
          </div>
        </div>

        <div className="flex-1 overflow-y-auto">
          <div className="p-2 border-primary/20">
                ...
                <div key={semester.id} className="group">
                  {editingSemesterId === semester.id ? (
                    ...
                    <div className="flex items-center gap-1 p-1">
                      <Button
                        variant="ghost"
                        className={`flex-1 justify-start text-left p-4 overflow-hidden min-w-0 ${isActive ? "bg-primary/8 hover:bg-primary/20" : "hover:bg-primary/10"}`}
            ...
            <Button onClick={onAddSemester} variant="outline" size="sm" className="w-full mt-2 h-8 text-xs bg-transparent">
